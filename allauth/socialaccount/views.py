...
class SignupView(
    ...
    template_name = "socialauth/socialaccount/signup." + account_settings.TEMPLATE_EXTENSION
...
class LoginCancelledView(TemplateView):
    template_name = (
        "socialauth/socialaccount/login_cancelled." + account_settings.TEMPLATE_EXTENSION
    )
...
class LoginErrorView(TemplateView):
    template_name = (
        "socialauth/socialaccount/authentication_error." + account_settings.TEMPLATE_EXTENSION
    )
...
class ConnectionsView(AjaxCapableProcessFormViewMixin, FormView):
    template_name = "socialauth/socialaccount/connections." + account_settings.TEMPLATE_EXTENSION
    ...
    def form_valid(self, form):
        get_account_adapter().add_message(
            self.request,
            messages.INFO,
            "socialauth/socialaccount/messages/account_disconnected.txt",
        )
        form.save()

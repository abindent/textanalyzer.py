...
def _add_social_account(request, sociallogin):
    ...
    level = messages.INFO
    message = "socialauth/socialaccount/messages/account_connected.txt"
    action = None
    if sociallogin.is_existing:
        if sociallogin.user != request.user:
            ...
            message = "socialauth/socialaccount/messages/account_connected_other.txt"
        else:
            # This account is already connected -- we give the opportunity
            # for customized behaviour through use of a signal.
            action = "updated"
            message = "socialauth/socialaccount/messages/account_connected_updated.txt"

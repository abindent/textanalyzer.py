...
class LogoutFunctionalityMixin(object):
    def logout(self):
        ...
        adapter.add_message(
            self.request, messages.SUCCESS, "socialauth/account/messages/logged_out.txt"
        )
...
class LoginView(
    ...
    template_name = "socialauth/account/login." + app_settings.TEMPLATE_EXTENSION
    success_url = None
...
class CloseableSignupMixin(object):
    template_name_signup_closed = (
        "socialauth/account/signup_closed." + app_settings.TEMPLATE_EXTENSION
    )
...
class SignupView(
    ...
    template_name = "socialauth/account/signup." + app_settings.TEMPLATE_EXTENSION
...
class ConfirmEmailView(TemplateResponseMixin, LogoutFunctionalityMixin, View):
    ...
    template_name = "socialauth/account/email_confirm." + app_settings.TEMPLATE_EXTENSION
    ...
    def post(self, *args, **kwargs):
        ...
        get_adapter(self.request).add_message(
            self.request,
            messages.SUCCESS,
            "socialauth/account/messages/email_confirmed.txt",
...
class EmailView(AjaxCapableProcessFormViewMixin, FormView):
    template_name = "socialauth/account/email." + app_settings.TEMPLATE_EXTENSION
    ...
    def form_valid(self, form):
        ...
        get_adapter(self.request).add_message(
            self.request,
            messages.INFO,
            "socialauth/account/messages/email_confirmation_sent.txt",
        ...
        if email_address:
            if email_address.primary:
                get_adapter(request).add_message(
                    request,
                    messages.ERROR,
                    "socialauth/account/messages/cannot_delete_primary_email.txt",
                ...
                get_adapter(request).add_message(
                    request,
                    messages.SUCCESS,
                    "socialauth/account/messages/email_deleted.txt",
                    {"email": email_address.email},
                )
        ...
        if email_address:
            ...
            if (
                ...
                get_adapter(request).add_message(
                    request,
                    messages.ERROR,
                    "socialauth/account/messages/unverified_primary_email.txt",
                )
            else:
                ...
                get_adapter(request).add_message(
                    request,
                    messages.SUCCESS,
                    "socialauth/account/messages/primary_email_set.txt",
                )
...
class PasswordChangeView(AjaxCapableProcessFormViewMixin, FormView):
    template_name = "socialauth/account/password_change." + app_settings.TEMPLATE_EXTENSION
    ...
    def form_valid(self, form):
        ...
        get_adapter(self.request).add_message(
            self.request,
            messages.SUCCESS,
            "socialauth/account/messages/password_changed.txt",
        )
...
class PasswordSetView(AjaxCapableProcessFormViewMixin, FormView):
    template_name = "socialauth/account/password_set." + app_settings.TEMPLATE_EXTENSION
    ...
    def form_valid(self, form):
        ...
        logout_on_password_change(self.request, form.user)
        get_adapter(self.request).add_message(
            self.request, messages.SUCCESS, "socialauth/account/messages/password_set.txt"
        )
...
class PasswordResetView(AjaxCapableProcessFormViewMixin, FormView):
    template_name = "socialauth/account/password_reset." + app_settings.TEMPLATE_EXTENSION
...
class PasswordResetFromKeyView(
    ...
    template_name = "socialauth/account/password_reset_from_key." + app_settings.TEMPLATE_EXTENSION
...
class PasswordResetFromKeyDoneView(TemplateView):
    template_name = (
        "socialauth/account/password_reset_from_key_done." + app_settings.TEMPLATE_EXTENSION
    )
...
class LogoutView(TemplateResponseMixin, LogoutFunctionalityMixin, View):
    ...
    template_name = "socialauth/account/logout." + app_settings.TEMPLATE_EXTENSION
    redirect_field_name = "next"
...
class AccountInactiveView(TemplateView):
    template_name = "socialauth/account/account_inactive." + app_settings.TEMPLATE_EXTENSION
...
class EmailVerificationSentView(TemplateView):
    template_name = "socialauth/account/verification_sent." + app_settings.TEMPLATE_EXTENSION

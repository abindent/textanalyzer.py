...
class AccountTests(TestCase):
    ...
    def test_password_reset_get(self):
        ...
        self.assertTemplateUsed(resp, "socialauth/account/password_reset.html")
    ...
    def test_password_reset_flow_with_empty_session(self):
        ...
        self.assertTemplateUsed(
            resp,
            "socialauth/account/password_reset_from_key.%s" % app_settings.TEMPLATE_EXTENSION,
        )
    ...
    def test_password_reset_flow_with_another_user_logged_in(self):
        ...
        resp = self.client.get(url)
        self.assertTemplateUsed(
            resp, "socialauth/account/password_reset_from_key.%s" % app_settings.TEMPLATE_EXTENSION
        )
        self.assertFalse("token_fail" in resp.context_data)
    ...
    def test_email_verification_mandatory(self):
        ...
        self.assertTemplateUsed(
            resp,
            "socialauth/account/verification_sent.%s" % app_settings.TEMPLATE_EXTENSION,
        )
        ...
        for attempt in [1, 2]:
            ...
            self.assertTemplateUsed(
                resp,
                "socialauth/account/verification_sent." + app_settings.TEMPLATE_EXTENSION,
            )
        ...
        self.assertTemplateUsed(
            resp, "socialauth/account/email_confirm.%s" % app_settings.TEMPLATE_EXTENSION
        )
    ...
    def test_logout_view_on_get(self):
        ...
        self.assertTemplateUsed(resp, "socialauth/account/messages/logged_out.txt")

    @override_settings(ACCOUNT_LOGOUT_ON_GET=False)
    def test_logout_view_on_post(self):
        c, resp = self._logout_view("get")
        self.assertTemplateUsed(
            resp, "socialauth/account/logout.%s" % app_settings.TEMPLATE_EXTENSION
        )
    ...
    def test_confirm_email_with_another_user_logged_in(self):
        ...
        self.assertTemplateUsed(resp, "socialauth/account/messages/logged_out.txt")
        self.assertTemplateUsed(resp, "socialauth/account/messages/email_confirmed.txt")
    ...
    def test_confirm_email_with_same_user_logged_in(self):
        ...
        self.assertTemplateNotUsed(resp, "socialauth/account/messages/logged_out.txt")
        self.assertTemplateUsed(resp, "socialauth/account/messages/email_confirmed.txt")
    ...
    def test_message_escaping(self):
        ...
        get_adapter().add_message(
            request, messages.SUCCESS, "socialauth/account/messages/logged_in.txt", context
        )
...
class EmailFormTests(TestCase):
    ...
    def test_add(self):
        ...
        self.assertTemplateUsed(resp, "socialauth/account/messages/email_confirmation_sent.txt")
    ...
    def test_remove_primary(self):
        ...
        self.assertTemplateUsed(
            resp, "socialauth/account/messages/cannot_delete_primary_email.txt"
        )
    ...
    def test_remove_secondary(self):
        ...
        self.assertTemplateUsed(resp, "socialauth/account/messages/email_deleted.txt")
    ...
    def test_set_primary_unverified(self):
        ...
        self.assertTemplateUsed(resp, "socialauth/account/messages/unverified_primary_email.txt")
    ...
    def test_set_primary(self):
        ...
        self.assertTemplateUsed(resp, "socialauth/account/messages/primary_email_set.txt")
    ...
    def test_add_with_two_limiter(self):
        ...
        self.assertTemplateNotUsed(resp, "socialauth/account/messages/email_confirmation_sent.txt")

...
def analyzed(request):
    ...
    if(remspecialchar == "on"):
        ...
        params = {'purpose':'Removed Special Characters', 'analyzed_text': analyzed}
        djtext = analyzed
    ...
    if (charcount == "on"):
       ...
       params = {'purpose': 'Counting no. of characters in your input', 'analyzed_text': analyzed }
...
def submit(request):
    ...
    space = "\r"
    br = "\n"
    greetings = "Hello" + space + name + space + "thanks for submitting the form. You have successfully lounged a support." 
     
    otherinfo = space + br + "Your email is" + space + email + space + "and your phone no. is" + space + phone + " ." + br + br
     
    yourquery = space + br + "You have submitted this as your query :" + space + '"' + query + '"'
...
def handleSignUp(request):
    if request.method=="POST":
        ...
        myuser.save()
        messages.success(request, " Your Text Analyzer account has been successfully created")
        return redirect('/')
